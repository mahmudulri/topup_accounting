...
ResellerDetailsModel resellerDetailsModelFromJson(String str) =>
    ResellerDetailsModel.fromJson(json.decode(str));

String resellerDetailsModelToJson(ResellerDetailsModel data) =>
    json.encode(data.toJson());

class ResellerDetailsModel {
  final bool? success;
  final Summary? summary;
  final List<Transaction>? transactions;
  final Pagination? pagination;

  ResellerDetailsModel({
    this.success,
    this.summary,
    this.transactions,
    this.pagination,
  ...
  factory ResellerDetailsModel.fromJson(Map<String, dynamic> json) =>
      ResellerDetailsModel(
...
class Summary {
  ...
  factory Summary.fromJson(Map<String, dynamic> json) => Summary(
    totalBaseAmount: json["total_base_amount"] == null
        ? null
        : json["total_base_amount"],
    totalPaidAmount: json["total_paid_amount"] == null
        ? null
        : json["total_paid_amount"],
    totalBonusAmount: json["total_bonus_amount"] == null
        ? null
        : json["total_bonus_amount"],
  );
