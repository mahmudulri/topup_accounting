...
class UpdateResellerController extends GetxController {
  ...
  Future<void> updatenow(String resellerID) async {
    try {
      isLoading.value = true;

      var url = Uri.parse(ApiEndPoints.baseUrl + "resellers/$resellerID");
