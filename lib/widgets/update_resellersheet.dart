...
import '../controllers/update_reseller_controller.dart';
import '../global_controllers/languages_controller.dart';
import '../utils/colors.dart';

void upldateresellersheet(BuildContext context, Map<String, dynamic> reseller) {
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    backgroundColor: Colors.transparent,
    builder: (_) => UpdateResellersheet(reseller: reseller),
  );
}

class UpdateResellersheet extends StatefulWidget {
  UpdateResellersheet({super.key, required this.reseller});

  final Map<String, dynamic> reseller;

  @override
  State<UpdateResellersheet> createState() => _UpdateResellersheetState();
}

class _UpdateResellersheetState extends State<UpdateResellersheet> {
  @override
  void initState() {
    super.initState();

    final data = widget.reseller;

    updateResellerController.nameController.text = data["name"] ?? "";
    updateResellerController.phoneController.text = data["phone"] ?? "";
    updateResellerController.cityController.text = data["city"] ?? "";
    updateResellerController.bonusController.text =
        data["bonus_percentage"]?.toString() ?? "";
  }
  ...
  UpdateResellerController updateResellerController = Get.put(
                    ...
                    child: Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            KText(
                              text: languagesController.tr("UPDATE_RESELLER"),
                              fontSize: 20,
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildTextField(
                          controller: updateResellerController.nameController,
                        ...
                        _buildTextField(
                          controller: updateResellerController.phoneController,
                        ...
                        _buildTextField(
                          controller: updateResellerController.cityController,
                        ...
                        _buildTextField(
                          controller: updateResellerController.bonusController,
                          hint: '0.00',
                          ...
                          onPressed: () {
                            if (updateResellerController
                                ...
                                updateResellerController
                                    ...
                                    .text
                                    .isNotEmpty) {
                              updateResellerController.updatenow(
                                widget.reseller["id"].toString(),
                              );
                            } else {
