...
import '../controllers/update_supplier_controller.dart';
import '../global_controllers/languages_controller.dart';
import '../utils/colors.dart';

void updateSuppliersheet(BuildContext context, Map<String, dynamic> supplier) {
  showModalBottomSheet(
    context: context,
    isScrollControlled: true,
    backgroundColor: Colors.transparent,
    builder: (_) => UpdateSuppliersheet(supplier: supplier),
  );
}

class UpdateSuppliersheet extends StatefulWidget {
  UpdateSuppliersheet({super.key, required this.supplier});

  final Map<String, dynamic> supplier;

  @override
  State<UpdateSuppliersheet> createState() => _UpdateSuppliersheetState();
}

class _UpdateSuppliersheetState extends State<UpdateSuppliersheet> {
  @override
  void initState() {
    super.initState();

    final data = widget.supplier;

    updateSupplierController.nameController.text = data["name"] ?? "";
    updateSupplierController.phoneController.text = data["phone"] ?? "";
    updateSupplierController.companyController.text = data["company"] ?? "";
    updateSupplierController.bonusController.text =
  ...
  UpdateSupplierController updateSupplierController = Get.put(
                    ...
                    child: Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            KText(
                              text: languagesController.tr("UPDATE_SUPPLIER"),
                              fontSize: 20,
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildTextField(
                          controller: updateSupplierController.nameController,
                        ...
                        _buildTextField(
                          controller: updateSupplierController.phoneController,
                        ...
                        _buildTextField(
                          controller:
                              updateSupplierController.companyController,
                        ...
                        _buildTextField(
                          controller: updateSupplierController.bonusController,
                          hint: '0.00',
                          ...
                          onPressed: () {
                            if (updateSupplierController
                                ...
                                updateSupplierController
                                    ...
                                    .text
                                    .isNotEmpty) {
                              updateSupplierController.updatenow(
